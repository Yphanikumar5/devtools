...
Docker()
	{
		...
		sudo yum-config-manager --disable docker-ce-edge
			...
			sudo yum install -y ftp://mirror.switch.ch/pool/4/mirror/scientificlinux/7x/external_products/extras/x86_64/container-selinux-2.9-4.el7.noarch.rpm
  
				#it will display all versions
